...
public class UserDataLoader {
	...
	//db.createUser({
	//	  user: "st-admin-20xx#1",
	//	  pwd: "$2y$12$vuSRMB4Tf8zLuXo.Gfx5WeNP0kmYlQ5zNS1O0rIoxR.h3CyMRswoi",
	//	  roles: [{ role: "readWrite", db: "st-admin" }]
	//	})
	//	{ ok: 1 }
    ...
    public void createRoles() throws Exception {
        List<String> roles = Stream.of("ROLE_ADMIN", "ROLE_USER").collect(Collectors.toList());
