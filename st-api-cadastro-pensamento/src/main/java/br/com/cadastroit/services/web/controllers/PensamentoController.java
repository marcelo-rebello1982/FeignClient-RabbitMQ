...
public class PensamentoController extends ApiCadastroCommonsController {
	...
	@Tag(name = "Order", description = "Get a Thoughts record by id")
	@GetMapping("/find/{id}")
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "500", description = "Internal Server Error", content = @Content),
			@ApiResponse(responseCode = "400", description = "Invalid id supplied", content = @Content) })
	@Tag(name = "Order", description = "Create a Thoughts record")
	@PostMapping("/create")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "Order updated with sucessful", content = {
					@Content(mediaType = "application/json", schema = @Schema(implementation = Pensamento.class)) }),
			@ApiResponse(responseCode = "400", description = "Invalid id supplied", content = @Content) })
	@Tag(name = "Order", description = "Updating a Thoughts record")
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "400", description = "Invalid id supplied", content = @Content) })
	@Tag(name = "Order", description = "Deleting a Thoughts record")
	...
	public ResponseEntity<Object> findByFilters(@RequestHeader("pessoaId") Long pessoaId, @RequestParam(required = false) Map<String, String> requestParams, @PathVariable("page") int page, @PathVariable("length") int length, @RequestBody PensamentoDTO dto) {
